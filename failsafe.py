...
logging.basicConfig(level=logging.INFO, format="%(asctime)s - FAILSAFE - %(message)s")

def global_exception_handler(exctype, value, tb):
    logging.critical("UNCAUGHT EXCEPTION - triggering auto-repair!", exc_info=(exctype, value, tb))
    try:
